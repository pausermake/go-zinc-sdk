...
// checks if the MetaAggregationMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaAggregationMetric{}
...
func (o MetaAggregationMetric) ToMap() (map[string]interface{}, error) {
