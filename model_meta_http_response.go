...
// checks if the MetaHTTPResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaHTTPResponse{}
...
func (o MetaHTTPResponse) ToMap() (map[string]interface{}, error) {
