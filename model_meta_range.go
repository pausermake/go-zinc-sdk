...
// checks if the MetaRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaRange{}
...
func (o MetaRange) ToMap() (map[string]interface{}, error) {
