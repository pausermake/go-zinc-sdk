...
// checks if the AggregationHistogramBound type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AggregationHistogramBound{}
...
func (o AggregationHistogramBound) ToMap() (map[string]interface{}, error) {
