...
// checks if the MetaDateRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaDateRange{}
...
func (o MetaDateRange) ToMap() (map[string]interface{}, error) {
