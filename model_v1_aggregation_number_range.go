...
// checks if the V1AggregationNumberRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1AggregationNumberRange{}
...
func (o V1AggregationNumberRange) ToMap() (map[string]interface{}, error) {
