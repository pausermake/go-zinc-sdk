...
func (r ApiListPermissionsRequest) Execute() ([]string, *http.Response, error) {
...
//
//	@return []string
func (a *PermissionAPIService) ListPermissionsExecute(r ApiListPermissionsRequest) ([]string, *http.Response, error) {
	var (
