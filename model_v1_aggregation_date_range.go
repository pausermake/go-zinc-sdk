...
// checks if the V1AggregationDateRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1AggregationDateRange{}
...
func (o V1AggregationDateRange) ToMap() (map[string]interface{}, error) {
